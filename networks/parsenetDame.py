...
class _ChannelAttention(nn.Module):
    ...
    def __init__(self, x1_planes, x2_planes, out_planes=256, reduction=8):
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        # Channel Attention
        self.c2_a = _ChannelAttention(x1_planes=64, x2_planes=128)
        self.c3_a = _ChannelAttention(x1_planes=128, x2_planes=256)
        self.c4_a = _ChannelAttention(x1_planes=256, x2_planes=512)
    ...
    def forward(self, x):
        ...
        # Segmentation 1  coarse segmente
